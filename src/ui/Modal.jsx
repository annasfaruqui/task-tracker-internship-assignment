...
function Window({ children, name, heading }) {
  ...
  return createPortal(
    <div className="z-1000 fixed left-0 top-0 h-screen w-full bg-black/20 backdrop-blur-sm">
      <div
        className="fixed left-1/2 top-1/2 w-2/5 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-lg bg-gradient-to-br from-purple-200 from-30% to-indigo-200 px-12 pb-5 pt-14 shadow-lg"
        ref={ref}
      >
